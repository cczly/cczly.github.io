...
我目前在中国科技大学苏州高级研究院任副研究员（硕士生导师）。我的研究兴趣包括具身人工智能和多模态内容生成与理解。如果您希望开展任何形式的学术合作，请随时发送邮件至 <strong>cczly@ustc.edu.cn</strong>。

<span class='anchor' id='-news'></span>

# 🔥 最新动态
- *2026.05*: 🎉 一篇会议论文被 ICML2026 接收。
- *2026.02*: 🎉 一篇期刊论文被 TNNLS 接收。
- *2025.11*: 🎉 一篇会议论文被 AAAI2026 接收。
- *2025.05*: 🎉 我们的论文被 ICME2025 选为口头报告。
- *2025.05*: 🎉 荣获华为 Spark 奖。
- *2025.05*: 🎉 一篇会议论文被 ICML2025 接收。
- *2025.04*: 🎉 本科生实习生完成的一篇论文被 IEEE IJCNN2025 接收。
- *2025.03*: 🎉 一篇会议论文被 IEEE ICME2025 接收。
- *2025.01*: 🎉 晋升为副研究员（硕导）。
